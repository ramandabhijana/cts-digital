                ...
                <div class="row">
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30">
                                    <img src="/static/user.png" class="img-rounder" width="150" alt="">
                                    <h4 class="card-title m-t-10">${patient.firstName} ${patient.lastName}</h4>
                                </center>
                            ...
                            <div class="card-body">
                                ...
                                <h6>${patient.dobString}</h6>
                                <small class="text-muted p-t-30 db">Patient Type</small>
                                <h6>${patient.typeString}</h6>
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal" id="update-profile-form" action="/user/updateprofile" method="post" onsubmit="alert('Your profile was updated')">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="dob" value="${patient.dobString}"
                                                           class="form-control form-control-line" required>
